        ...
        <div className='bg-gray-400 w-70 h-80 rounded-2xl shadow-2xl hover:scale-110 transition-all'>
            ...
            <div className='p-4 flex justify-center items-center flex-col my-1'>
                ...
                <button onClick={()=>{
                 ...
                 className='bg-red-500 text-white px-4 py-2 rounded-3xl text-center font-bold active:scale-105 active:bg-red-400 border hover:scale-95 transition-all ' >Add to Cart <span className='hidden'>{props.id + 1}</span></button>
            </div>
        </div>
    )
}
